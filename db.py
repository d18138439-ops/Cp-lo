...
class Database:
    ...
    def _print_startup_message(self):
        ...
        print(f"\n{Fore.CYAN}{'='*50}")
        print(f"{Fore.CYAN}🚀 SANU Bot - Database Initialization")
    ...
    def get_user(self, user_id: int, bot_username: str = "SANU") -> Optional[dict]:
        """
        Retrieve a user document
        
        Args:
            user_id: Telegram user ID
            bot_username: Bot username (default: "SANU")
    ...
    def is_user_authorized(self, user_id: int, bot_username: str = "SANU") -> bool:
        """
    ...
    def add_user(self, user_id: int, name: str, days: int, 
                bot_username: str = "SANU") -> tuple[bool, Optional[datetime]]:
        """
    ...
    def remove_user(self, user_id: int, bot_username: str = "SANU") -> bool:
        """
    ...
    def list_users(self, bot_username: str = "SANU") -> List[dict]:
        """
    ...
    def list_bot_usernames(self) -> List[str]:
        ...
        try:
            ...
            return usernames if usernames else ["SANU"]
        except Exception as e:
    ...
    def get_user_expiry_info(self, user_id: int, bot_username: str = "SANU") -> Optional[dict]:
        """
...
# 🔰 Startup Message
print(f"\n{Fore.CYAN}{'='*50}")
print(f"🤖 Initializing SANU Bot Database")
print(f"{'='*50}{Style.RESET_ALL}\n")
